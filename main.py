...
from config.config import conf, root_prefix
from routes import units, customer, owner, auth, admin, docs, utility
...
app.include_router(admin.admin, prefix=root_prefix)
app.include_router(auth.auth, prefix=root_prefix)
app.include_router(units.units, prefix=root_prefix)
app.include_router(customer.customer, prefix=root_prefix)
app.include_router(owner.owner, prefix=root_prefix)
app.include_router(utility.utility, prefix=root_prefix)
app.include_router(docs.docs, prefix=root_prefix, include_in_schema=False)
